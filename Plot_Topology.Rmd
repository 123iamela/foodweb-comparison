...
>>>>>>> a318c35e650ac1c2393cffef07255049b2050492
dev.off()
```
...
<<<<<<< HEAD
      geom_segment(data=qssp_sim, aes(x=q7[1], xend=q7[1], y=7, yend=0), colour=colnet[2], size=1.25, linetype=1) +
      geom_segment(data=qssp_sim, aes(x=q7[2], xend=q7[2], y=7, yend=0), colour=colnet[2], size=1.25, linetype=1) + 
      ...
      geom_segment(data=qssb_sim, aes(x=q8[1], xend=q8[1], y=7, yend=0), colour=colnet[9], size=1.25, linetype=1) +
      geom_segment(data=qssb_sim, aes(x=q8[2], xend=q8[2], y=7, yend=0), colour=colnet[9], size=1.25, linetype=1) + 
=======
...
ggsave("2020/Figures/ti_PCBC.tiff", width=11, height=12, units="in", dpi=300)
=======
