...
# Plot networks
tiff("2020/Figures/fw.tif", width=12, height=8, units="in", res=1000)
...
g5 <- ggplot(tiMIC, aes(PathLength)) + 
        geom_histogram(data=simp, fill=colnet[5], color=colnet[5], bins=50) + 
        geom_histogram(data=simb, fill=colnet[12], color=colnet[12], bins=50) +
        xlab("Characteristic path length") + 
        ylab("Frequency") + 
...
ggsave("C:/Users/iamia/Google Drive (iaradiamelar@gmail.com)/Escrito/Paper/ti2_PCBC.tiff", width=11, height=15, units="in", dpi=1000)

#rm(datp,datb,simp,simb)
#rm(q1,q2,q3,q4,q5,q6,q7,q8,q9,q10,q11,q12)
#rm(legend1,g1,g2,g3,g4,g5,g6,ggg,row1,row2,row3,row4)
