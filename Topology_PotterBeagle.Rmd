...
if(!file.exists("Data/tiIC95.rds")){
    ...
    ptiQSS <- calc_QSS(pRedCB, 1000, 4) %>% mutate(Name="Potter")
    btiQSS <- calc_QSS(bRedCB, 1000, 4) %>% mutate(Name="Beagle")
